...
public interface BaseController <E, ID extends Serializable> {
    ...
    public ResponseEntity<?>save(@RequestBody E entity);//@RequestBody indica que un parámetro de método debe estar vinculado al valor del cuerpo de la solicitud HTTP.
